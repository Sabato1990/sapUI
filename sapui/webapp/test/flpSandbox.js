		...
		services: {
					...
					"config": {
						"groups": [{
							"tiles": [{
								...
								"properties": {
									"title": "First app",
									"targetURL": "#comwebinarsapui-display"
								}
							}]
						}]
					}
			...
			"ClientSideTargetResolution": {
				"adapter": {
					"config": {
						"inbounds": {
							"comwebinarsapui-display": {
								"semanticObject": "comwebinarsapui",
								"action": "display",
								...
								"resolutionResult": {
									...
									"additionalInformation": "SAPUI5.Component=com.webinar.sapui",
									"url": sap.ui.require.toUrl("com/webinar/sapui")
								}
							}
						}
					}
